			...
			<div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row md:items-start gap-8 md:gap-16">
				<div className="w-full flex flex-col gap-8">
					...
					<div className="flex flex-col gap-2">
						<div className="w-max p-4 bg-accent-foreground dark:bg-primary/10 rounded border-l-8 border-primary flex flex-col gap-2">
				...
				<div className="w-full bg-background grid grid-cols-2 grid-rows-2 gap-4">
					{squareButtons.map(({ href, icon, label }) => (
						<Link
							key={label}
							href={href}
							target="_blank"
