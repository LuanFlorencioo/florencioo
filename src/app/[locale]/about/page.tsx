...
export default function AboutPage() {
	return (
		<section className="w-full px-4 pt-16 pb-32 selection:bg-primary selection:text-white">
			<div className="w-full flex items-start justify-center gap-32">
				<div className="w-full max-w-lg flex flex-col items-start gap-8 md:gap-16">
					<div className="flex flex-col gap-4">
						...
						<p className="leading-7">
							...
							Desenvolvimento de Sistemas, tenho domínio em Desenvolvimento Web
							Fullstack, com especialização em tecnologias como JavaScript,
							TypeScript, React, Next.js, Node.js e NestJS.
						</p>
					...
					<div className="flex flex-col gap-4">
						...
						<p className="leading-7">
							Minha jornada na tecnologia começou na infância, quando desenvolvi
							uma grande curiosidade por computadores, aplicativos e programas.
							Desde então, venho aprimorando minhas habilidades para construir
				...
				<figure className="hidden lg:block w-[300px] aspect-square opacity-0 animate-home-hero">
