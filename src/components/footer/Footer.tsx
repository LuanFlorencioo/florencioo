...
export function Footer() {
	return (
		<footer className="w-full px-4 py-16 border-t bg-background selection:bg-primary">
			<div className="w-full max-w-6xl mx-auto flex items-start justify-between gap-4">
				<div className="flex flex-col items-start gap-2">
					<div className="w-max flex items-center gap-2">
						<p className="text-xs text-muted-foreground">Feito em</p>

						<Link href="https://nextjs.org/" target="_blank">
							<svg viewBox="0 0 128 128" className="size-12 fill-foreground">
						...
						<p className="text-xs text-muted-foreground">por mim 😀</p>
					</div>
				...
				<div className="size-10 relative opacity-50 hover:animate-spin">
					<Image src={Logo} alt="Logo" fill className="grayscale" />
				</div>
			</div>
		</footer>
	);
